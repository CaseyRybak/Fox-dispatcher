...
Первый сценарий проверяет рейтинг, фильтры, доказательства и 320 px reflow. Второй — навигацию Worklog, 6 чекпоинтов, публичные ссылки, отсутствие приватных данных и мобильный layout. Третий — редактирование, пересчёт лидера, удаление, undo, фокус, reload и локальное сохранение.
...
Фазы 0–5 опубликованы на `main`; Phase 5 вошла в `0021c6d`. Текущие consistency-аудит исправления остаются незакоммиченными. Публичный Vercel-деплой выполняется отдельно в фазе 7.
