...
Фазы 0–8 завершены локально. Публичный Vercel-релиз пока содержит фазу 7 на ревизии `170ee1d`; фаза 8 проверена в production preview, но ещё не закоммичена, не отправлена в GitHub и не развёрнута.
