...
| **1.3.3** Sensory Characteristics | Instructions combine text with shape, color, size, location, orientation, or sound cues |
...
<p id="email-hint">Your email stays private.</p>
```
